...
class DjangoAppPlugin(plugins.SimplePlugin):
    ...
    def __init__(
        ...
        local_settings: typing.Optional[Settings] = None,
    ) -> None:
...
if __name__ == "__main__":
    ...
    parser.add_argument("-p", "--port", type=int, required=False, action="store", help="Override port.")
    ...
    DjangoAppPlugin(
        ...
        local_settings=crawler_settings,
    ).subscribe()
    ...
    cherrypy.log("Loading and serving Panda Backup. Listening on {}".format(listening_on_message))
