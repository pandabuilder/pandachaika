...
urlpatterns = [
    ...
    re_path(r"^archive-manage/(\d+)/remove-from-index/$", archive.remove_from_index_manage_archive, name="archive-manage-remove-from-index"),
    re_path(r"^archive-manage/(\d+)/add-to-index/$", archive.add_to_index_manage_archive, name="archive-manage-add-to-index"),
    ...
    re_path(r"^gallery-find/([\w-]+)/$", head.gallery_details_gid_provider, name="gallery-find-tool"),
    re_path(r"^gallery-find/$", head.gallery_details_gid_provider, name="gallery-find"),
    re_path(r"^wanted-gallery/(\d+)/$", wanted.wanted_gallery, name="wanted-gallery"),
    re_path(
        r"^user-archive-preferences/(\d+)/([\w-]+)/$", head.user_archive_preferences, name="user-archive-preferences"
    ),
...
urlpatterns += [
    ...
    re_path(
        ...
        name="archive-filesize-different",
    ),
...
urlpatterns += [
    ...
    re_path(r"^col-gallery-update/(\d+)/([\w-]+)/$", collaborators.gallery_update, name="col-gallery-update-tool"),
    re_path(r"^col-gallery-update/(\d+)/([\w-]+)/(\d*)/$", collaborators.gallery_update, name="col-gallery-update-tool-id"),
    re_path(r"^col-update/(\d+)/([\w-]+)/$", collaborators.archive_update, name="col-archive-update-tool"),
    re_path(
        r"^col-update/(\d+)/([\w-]+)/([\w-]+)/$", collaborators.archive_update, name="col-archive-update-tool-name"
    ),
