(function(l,h,q){"function"===typeof define&&define.amd?define(function(){return h({},l)}):"object"===typeof module&&module.exports?(q="undefined"!==typeof window?window:"undefined"!==typeof global?global:{},module.exports=h({},q)):"object"===typeof exports?(q="undefined"!==typeof window?window:"undefined"!==typeof global?global:{},exports=h({},q)):l.Keys=h({},window)})(this,function(l,h,q){function w(){for(var a=Array.prototype.slice.call(arguments),b=0;b<a.length;b++)if(null!==a[b]&&"undefined"===
typeof a[b])return!1;return!0}function x(a,b,c){(!c||l.debug)&&a.slice().forEach(function(a){b.call(null,a)});return a}function y(a){var b=Array.prototype.slice.call(arguments,1);return a.map(function(a,e){for(var d=[],g=0;g<b.length;g++){var m=b[g]&&b[g][e];d.push(null!==m&&"undefined"!==typeof m?m:null)}return[a].concat(d)})}function r(a,b){for(var c=0;c<a.length;c++)if(b(a[c]))return a[c];return null}function d(a,b){this.name=a;this.code=b;d.internals.keymap[a]=d.internals.keymap[a]||b}function f(a,
b){function c(a,b){return null!==r(a,function(a){return b.eq(a)})}var e=null;if(2===arguments.length&&b instanceof Array)e=b;else if(2<=arguments.length)e=Array.prototype.slice.call(arguments,1);else{if(1===arguments.length){this.key=a;this.ctrl=a.eq(d.CTRL);this.shift=a.eq(d.SHIFT);this.alt=a.eq(d.ALT);this.meta=a.eq(d.META)||a.eq(d.META_RIGHT);return}throw Error("Combo: Invalid number of arguments provided.");}if(r(e,function(a){switch(a.code){case d.CTRL.code:case d.SHIFT.code:case d.ALT.code:case d.META.code:case d.META_RIGHT.code:return!1;
default:return!0}}))throw Error("Combo: Attempted to create a Combo with multiple non-meta Keys. This is not supported.");this.key=a;this.ctrl=c(e,d.CTRL)||a.eq(d.CTRL);this.shift=c(e,d.SHIFT)||a.eq(d.SHIFT);this.alt=c(e,d.ALT)||a.eq(d.ALT);this.meta=(this.meta=c(e,d.META)||c(e,d.META_RIGHT))||a.eq(d.META)||a.eq(d.META_RIGHT)}function t(a){if(!a||!(a instanceof Array))a=[!1,!1,!1,!1];return y(d.metaKeys,a).filter(function(a){return!0===a[1]}).map(function(a){return a[0]})}function k(){this.bindings=
[];this.handlers=[];this.enable()}l=l||{};l.debug=!1;Function.prototype.bind||(Function.prototype.bind=function(a){var b=this;return function(){var c=Array.prototype.slice.call(arguments);return b.apply(a,c)}});var v=Function.prototype.bind;Array.prototype.forEach||(Array.prototype.forEach=function(a,b){if(!this)throw Error("forEach: Array is null or undefined.");if("function"!==typeof a)throw Error("forEach: Iterator is not callable.");var c=this.length>>>0,e=0;for(b=b||null;e<c;)Object.prototype.hasOwnProperty.call(this,
...
a=t([a.ctrl,a.alt,a.shift,a.meta]);return a.length?new f(b,a):new f(b)};f.fromEvent=function(a){if(!a||!a.which&&!a.keyCode)return null;var b=d.fromCode(a.which||a.keyCode);if(!b)return null;a=t([a.ctrlKey,a.altKey,a.shiftKey,a.metaKey]);return a.length?new f(b,a):new f(b)};f.fromString=function(a){var b=a.split("+").filter(function(a){return!a?!1:!0});a=d.fromName(b.length?b[b.length-1]:b[0]);if(b.length){if(1<b.length){var c=-1<b.indexOf("CTRL"),e=-1<b.indexOf("ALT"),n=-1<b.indexOf("SHIFT"),b=-1<
b.indexOf("META")||-1<b.indexOf("META_RIGHT"),c=t([c,e,n,b]);if(a&&c.length)return new f(a,c);throw Error("Combo.fromString: Invalid Combo string, more than one non-meta key was specified.");}if(a)return new f(a)}throw Error("Combo.fromString: Invalid Combo string.");};f.prototype.eq=function(a){return!a||!(a instanceof f)?!1:this.key.eq(a.key)?this.shift!==a.shift?!1:this.alt!==a.alt?!1:this.ctrl!==a.ctrl?!1:this.meta!==a.meta?!1:!0:!1};f.prototype.isMatch=function(a){if(!a&&!(a instanceof f))throw Error("Combo.isMatch called with an invalid Combo object.");
if(this.key.isMeta()){if((this.shift||this.key.eq(d.SHIFT))!==a.shift||(this.alt||this.key.eq(d.ALT))!==a.alt||(this.ctrl||this.key.eq(d.CTRL))!==a.ctrl||(this.meta||this.key.eq(d.META)||this.key.eq(d.META_RIGHT))!==a.meta)return!1}else return this.eq(a);return!0};f.prototype.metaKeys=function(){var a=[this.ctrl||this.key.eq(d.CTRL),this.alt||this.key.eq(d.ALT),this.shift||this.key.eq(d.SHIFT),this.meta||this.key.eq(d.META)||this.key.eq(d.META_RIGHT)];return t(a)};l.Combo=f;k.prototype.onInputEvent=
...
b),h.document.detachEvent("onkeyup",b),h.document.detachEvent("onkeypress",b)),this.bindings.forEach(function(a){a.enabled=!1}))};k.prototype.get=function(a){return r(this.bindings,function(b){return b.name===a})};k.prototype.load=function(a){if(!a||!a.constructor||"Object"!==a.constructor.name)throw Error("Bindings.load: `specs` must be an object.");for(var b in a)if(Object.prototype.hasOwnProperty.call(a,b)){var c="Bindings.load: The specs object provided contains an invalid binding specification `"+
b+"` - ";if(!a[b]||!a[b].constructor||"Object"!==a[b].constructor.name)s(c+"invalid value type.");else{var e=b,n=a[b].description||"",g=a[b].bind,m=a[b].handler,h=a[b].eventType,k=a[b].isGlobal||!1;if(w(g,m)){var l;l=!m||"function"!==typeof m?!1:!0;l?g instanceof Array||g instanceof f||g instanceof d?(c=[e,n].concat(g),this.add.apply(this,c),h?this.registerHandler.call(this,e,h,m,k):this.registerHandler.call(this,e,m,k)):s(c+"bind must be an instance of Array, Combo, or Key"):s(c+"handler must be a function.")}else s(c+
"requires definition of bind or handler.")}}};k.prototype.add=function(a,b){var c=[],e=b&&"string"===typeof b?b:"",c=b&&"string"!==typeof b?Array.prototype.slice.call(arguments,1):Array.prototype.slice.call(arguments,2);if((e?3>arguments.length:2>arguments.length)||!a||!c.length)throw Error("Keybindings.add: Invalid arguments provided");c.forEach(function(a){if(!(a instanceof f||a instanceof d))throw Error("Keybindings.add: `combo` must be an instance of Key or Combo");});var n=r(this.bindings,function(b){return b.name===
...
b){for(var c=0;c<a.length;c++)if(b(a[c]))return!0;return!1}var c=this.bindings.filter(function(c){return c.enabled&&b(c.combos,function(b){return b instanceof d?a.key.eq(b):b.isMatch(a)})});return this.handlers.filter(function(a){return r(c,function(b){return b.name===a.name})})};l.Bindings=k;return l});
