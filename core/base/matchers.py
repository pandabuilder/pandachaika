...
class Matcher(metaclass=Meta):
    ...
    def create_closer_matches_values(
        self, title: str, cutoff: Optional[float] = None, max_matches: int = 20
        ...
        logger.info("For matcher: {}, searching using title: {}.".format(str(self), title_to_search))
        ...
        if self.search_method(title_to_search):
            ...
            logger.info("For matcher: {}, found {} results before filtering.".format(str(self), len(galleries_data)))
            if galleries_data:
