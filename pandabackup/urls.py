...
from viewer.views.complete import (
    ArchiveAutocomplete,
    TagAutocomplete,
    NonCustomTagAutocomplete,
    CustomTagAutocomplete,
    GalleryAutocomplete,
    SourceAutocomplete,
    ReasonAutocomplete,
    UploaderAutocomplete,
    WantedGalleryAutocomplete,
    ProviderPkAutocomplete,
    CategoryAutocomplete,
    ProviderAutocomplete,
    TagPkAutocomplete,
    GallerySelectAutocomplete,
    ArchiveSelectAutocomplete,
    ArchiveGroupAutocomplete,
    ArchiveGroupSelectAutocomplete,
    ArchiveSelectSimpleAutocomplete,
    GalleryProviderAutocomplete,
    GalleryCategoryAutocomplete,
    GalleryUploaderAutocomplete,
    GalleryReasonAutocomplete,
    WantedGalleryColAutocomplete,
    ArchiveManageEntryMarkReasonAutocomplete,
...
urlpatterns += [
    ...
    re_path(
        r"^" + settings.MAIN_URL + r"category-pk-autocomplete/$",
        CategoryPkAutocomplete.as_view(),
        name="category-pk-autocomplete",
    ),
    # Gallery
    re_path(
